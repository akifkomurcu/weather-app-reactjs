...
function Fetch({ result }) {
  ...
  return (
    <div className="container">
      <div className="row ">
        <div className="card today col-sm-auto col-md-auto">
          <img
            src={`https://openweathermap.org/img/wn/${obj.icon1}.png`}
          ...
          <div className="card-body">
            ...
            <p className="card-text-cel">
              Max: {obj.highesttemp1}°<br /> Min: {obj.lowesttemp1}°
            </p>
          </div>
        </div>
        <div className="card col-xs-12 col-sm-auto col-md-auto">
          <img
            src={`https://openweathermap.org/img/wn/${obj.icon2}.png`}
            className="card-img-top"
            alt="..."
            style={{ width: "50px", margin: "0 auto" }}
          />
        ...
        <div className="card col-xs-12 col-sm-auto col-md-auto">
          <img
            src={`https://openweathermap.org/img/wn/${obj.icon3}.png`}
            className="card-img-top"
            alt="..."
            style={{ width: "50px", margin: "0 auto" }}
          />
        ...
        <div className="card col-xs-12 col-sm-auto col-md-auto">
          <img
            src={`https://openweathermap.org/img/wn/${obj.icon4}.png`}
            className="card-img-top"
            alt="..."
            style={{ width: "50px", margin: "0 auto" }}
          />
        ...
        <div className="card col-xs-12 col-sm-auto col-md-auto">
          <img
            src={`https://openweathermap.org/img/wn/${obj.icon5}.png`}
            className="card-img-top"
            alt="..."
            style={{ width: "50px", margin: "0 auto" }}
          />
          <div className="card-body">
            ...
            <p className="card-text-cel">
              Max: {obj.highesttemp5}°<br /> Min: {obj.lowesttemp5}°
            </p>
          </div>
        </div>
        <div className="card col-xs-12 col-sm-auto col-md-auto">
          <img
            src={`https://openweathermap.org/img/wn/${obj.icon6}.png`}
            className="card-img-top"
            alt="..."
            style={{ width: "50px", margin: "0 auto" }}
          />
        ...
        <div className="card col-xs-12 col-sm-auto col-md-auto">
          <img
            src={`https://openweathermap.org/img/wn/${obj.icon7}.png`}
            className="card-img-top"
            alt="..."
            style={{ width: "50px", margin: "0 auto" }}
          />
          <div className="card-body">
            ...
            <p className="card-text-cel">
              Max: {obj.highesttemp7}°<br /> Min: {obj.lowesttemp7}°
            </p>
          </div>
        </div>
